 ...
 * Admin API class.
 */
class Tika_Doc_PDF_Indexer_Admin_API {
	...
	public function display_field( $data = array(), $post = false, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'tika-doc-pdf-indexer' ) . '" data-uploader_button_text="' . __( 'Use image', 'tika-doc-pdf-indexer' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'tika-doc-pdf-indexer' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'tika-doc-pdf-indexer' ) . '" />' . "\n";
